...
export const HERO_CONTENT = `I am a dedicated Computer Science and Engineering student specializing in Data Science, currently studying at ABES Engineering College, Ghaziabad. My academic journey, with a CGPA of 7.74, reflects my commitment to mastering the technical skills needed to solve complex problems. I have hands-on experience in Python, SQL, Java, C/C++, and JavaScript, along with proficiency in cloud computing, data science, and machine learning. My projects, such as an Ayurvedic disease detection app and a movie recommendation system, showcase my ability to apply machine learning to practical, real-world scenarios. I’ve also earned a 6-star rating in Problem Solving on Hackerrank and completed over 500 coding challenges across various platforms.`;

export const ABOUT_TEXT = `I am a passionate and versatile Computer Science and Engineering student specializing in Data Science, with a CGPA of 7.74. My expertise spans Python, SQL, and various machine learning frameworks, which I’ve applied to projects such as an Ayurvedic disease detection app and a movie recommendation system. Driven by a deep curiosity for technology, I am committed to continuous learning and problem-solving. I thrive in collaborative environments and enjoy tackling complex challenges to deliver high-quality, data-driven solutions. Outside of my studies, I stay engaged with emerging technologies and contribute to open-source projects, always eager to innovate and make a meaningful impact in the tech industry.`;
